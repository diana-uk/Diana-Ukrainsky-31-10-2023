// URLs and endpoints for the AccuWeather API across the application
export const WEATHER_API_BASE_URL = "http://localhost:3000";
export const REAL_ACCUWEATHER_API_BASE_URL =
  "https://dataservice.accuweather.com/";
export const CURRENT_WEATHER_API_URL = `${REAL_ACCUWEATHER_API_BASE_URL}/currentconditions/v1`;
