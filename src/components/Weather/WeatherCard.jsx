  ...
  const renderDayInfo = () => (
    <>
      ...
      <div className={classes["c-weather-card-image"]}>
        <img
          src={`https://raw.githubusercontent.com/diana-uk/Diana-Ukrainsky-31-10-2023/diana-abra-weather-app/src/assets/weather-icons/${weatherItem?.dayWeather.icon}.png`}
          alt="weather icon"
        />
      </div>
  ...
  const renderFullDetails = () => (
    ...
    >
      ...
      >
        ...
        <div className={classes["c-weather-card-image"]}>
          <img
            src={`https://raw.githubusercontent.com/diana-uk/Diana-Ukrainsky-31-10-2023/diana-abra-weather-app/src/assets/weather-icons/${weatherItem?.currentWeather.weatherIcon}.png`}
            alt="weather icon"
          />
        </div>
        <div className={classes["c-weather-card-temp"]}>
